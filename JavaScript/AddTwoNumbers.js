...
var addTwoNumbers = function(l1, l2) {
    ...
    l1 = l1.next ? l1.next : {};
    l2 = l2.next ? l2.next : {};
    while(typeof l1.val !== "undefined"|| typeof l2.val !== "undefined") { //while at least one list can be interated
      tmp.next = new ListNode(((l1.val + l2.val) + carry) % 10); //create new linked list by starting at end
      carry = (l1.val + l2.val + carry) % 10 !== l1.val + l2.val + carry ? 1 : 0;
      tmp = tmp.next;
      l1 = l1.next ? l1.next : {};
      l2 = l2.next ? l2.next : {};
...
var l1 = fillList([6,4,5,0,4,4,9,4,1]), l2 = fillList([3,8,8,0,3,0,1,4,8]);

listcount(addTwoNumbers(l1,l2));
